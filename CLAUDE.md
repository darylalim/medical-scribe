...
- Both SOAP card render paths (streaming markdown during generation; always-editable text_areas post-stream) share the single `_render_section_header(name)` helper for the chip + name header — iterate the visual there.
